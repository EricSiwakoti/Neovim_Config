...
conf.center = {
  ...
  desc = function()
      local footer = conf.footer
      footer.index = (footer.index % #footer.messages) + 1
      return footer.messages[footer.index]
  end,
}
...
api.nvim_create_autocmd("FileType", {
  ...
  callback = function ()
    ...
    vim.cmd "e" -- Reload the buffer to update the message
  end
})
